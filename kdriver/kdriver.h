...
const ULONG IOCTL_KDRIVER_START_FILTER = CTL_CODE(FILE_DEVICE_KDRIVER, 0x02, METHOD_BUFFERED, FILE_READ_DATA | FILE_WRITE_DATA);
const ULONG IOCTL_KDRIVER_STOP_FILTER = CTL_CODE(FILE_DEVICE_KDRIVER, 0x03, METHOD_BUFFERED, FILE_READ_DATA | FILE_WRITE_DATA);
